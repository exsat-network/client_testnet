...
# Enter the synchronizer subdirectory
cd "synchronizer" || { echo "Failed to enter directory synchronizer"; exit 1; }
...
# Start the synchronizer script
echo "Starting synchronizer..."
yarn start || { echo "synchronizer failed to start"; exit 1; }

echo "synchronizer started successfully."
